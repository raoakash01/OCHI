...
function Footer() {
    ...
    <div className="data-scroll data-scroll-section data-scroll-speed='.1'  w-full h-screen bg-zinc-100 px-10 py-20 flex">
        ...
        <div className="w-1/2">
        <h1 className="text-[7vw] font-semibold uppercase leading-none ">PRESENTATION</h1>
        ...
        <div className="w-1/2">
            ...
            <p className="font-['Founders Grotesk'] mb-15 mt-5">L:</p>
            <div className="dels font-['Neue Montreal']">
                <a text-xl block font-light>202-1965 W 4th Ave</a><br></br>
                <a text-xl block font-light>Vancouver, Canada</a><br></br><br></br><br></br>
                <a text-xl block font-light>30 Chukarina St</a><br></br>
                <a text-xl block font-light>Lviv, Ukraine</a><br></br>
            </div>
            <p className="font-['Founders Grotesk'] mb-15 mt-5">E:</p>
            <div className="dels font-['Neue Montreal']">
                <a text-xl block font-light>hello@ochi.design</a><br></br>
            </div>
        </div>
        <div className="w-1/2 mt-32 px-20">
        <p className="font-['Founders Grotesk'] mb-15 mt-5">M:</p>
            <div className="dels font-['Neue Montreal']">
            <a text-xl block font-light>Home</a><br></br>
                <a text-xl block font-light>Services</a><br></br>
                <a text-xl block font-light>Our Work</a><br></br>
                <a text-xl block font-light>About Us</a><br></br>
                <a text-xl block font-light>Insights</a><br></br>
                <a text-xl block font-light>Contact Us</a><br></br>
            </div>
        </div>
        </div>
        </div>
